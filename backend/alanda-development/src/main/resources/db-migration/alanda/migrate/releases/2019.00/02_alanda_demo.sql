...
Insert into PMC_PERMISSION (GUID,VERSION,KEY) values (4,0,'ms:write:VACATION:*:ACTIVE:*:VACATION_START:act');
Insert into PMC_PERMISSION (GUID,VERSION,KEY) values (5,0,'ms:write:VACATION:*:ACTIVE:*:VACATION_END:act');
