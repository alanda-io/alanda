...
public class ElasticSearchVariable implements Serializable {
  ...
  public ElasticSearchVariable(HistoricVariableUpdateEventEntity variableUpdateEvent) {
    ...
    if (variableUpdateEvent.getTextValue() != null) {
      this.textValue = variableUpdateEvent.getTextValue();
    } else if (variableUpdateEvent.getLongValue() != null) {
      this.textValue = variableUpdateEvent.getLongValue().toString();
    }
  ...
  public String toString() {
    return "ElasticSearchVariable [" +
      (variableInstanceId != null ? "variableInstanceId=" + variableInstanceId + ", " : "") +
      (serializerName != null ? "serializerName=" + serializerName + ", " : "") +
      (textValue != null ? "textValue=" + textValue + ", " : "") +
      (varName != null ? "varName=" + varName + ", " : "") +
      "global=" +
      global +
      ", " +
      (scopeActivityInstanceId != null ? "scopeActivityInstanceId=" + scopeActivityInstanceId + ", " : "") +
