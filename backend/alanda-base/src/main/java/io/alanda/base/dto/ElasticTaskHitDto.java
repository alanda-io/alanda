...
public class ElasticTaskHitDto extends PmcProjectCompactDto {
...
//  Long version;
  ...
  Collection<ElasticTaskHitDto> parents;

  Collection<ElasticTaskHitDto> children;
   ...
   * @param guid
   */
  public ElasticTaskHitDto(Long guid) {
    super();
    this.guid = guid;
  }
  ...
  public Collection<ElasticTaskHitDto> getChildren() {
    return children;
  }

  public void setChildren(Collection<ElasticTaskHitDto> children) {
  ...
  public Collection<ElasticTaskHitDto> getParents() {
    return parents;
  }

  public void setParents(Collection<ElasticTaskHitDto> parents) {
    this.parents = parents;
  }

  public void addParent(ElasticTaskHitDto p) {
    if (parents == null) {
