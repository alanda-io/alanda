 ...
 * @since 1.0.0
 */
public class PMCNegotiateAuthenticationFilter extends AuthenticatingFilter {
    ...
    public PMCNegotiateAuthenticationFilter() {
        PMCNegotiateAuthenticationFilter.PROTOCOLS.add("Negotiate");
        PMCNegotiateAuthenticationFilter.PROTOCOLS.add("NTLM");
    }
