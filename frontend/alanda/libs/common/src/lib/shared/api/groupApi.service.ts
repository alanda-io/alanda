...
export class AlandaGroupApiService extends AlandaExceptionHandlingService {
  ...
  ): Observable<AlandaListResult<AlandaGroup>> {
    return this.http
      .post<AlandaListResult<AlandaGroup>>(
        `${this.endpointUrl}/list`,
        serverOptions,
      )
      .pipe(
        catchError(
          this.handleError<AlandaListResult<AlandaGroup>>('getGroups', null),
        ),
      );
  }
  ...
  getEffectivePermissionsForGroup(
    ...
    return this.http
      .get<AlandaPermission[]>(
        `${this.endpointUrl}/permissions/effective/${guid}`,
      )
      .pipe(
        catchError(
  ...
  ): Observable<AlandaGroup> {
    return this.http
      .put<AlandaGroup>(
        `${this.endpointUrl}/permissions/update/${guid}`,
        permissions,
      )
  ...
  updateRolesForGroup(
    ...
    return this.http
      .put<AlandaGroup>(`${this.endpointUrl}/roles/update/${guid}`, roles)
